...
final class ItemParamConverterTest extends TestCase
{
    ...
    {
        $this->assertTrue($this->paramConverter->supports(new ParamConverter(array('class' => ItemInterface::class))));
        $this->assertFalse($this->paramConverter->supports(new ParamConverter(array('class' => LocationInterface::class))));
    }
}
